...
def create_csv(csv_directory, df):
    ...
    # Insert an empty string as the first element in the list
    all_values.insert(0, '')
    # Create a DataFrame with a single row containing all values
    single_row_df = pd.DataFrame([all_values])

    csv_save_path = os.path.join(csv_directory, 'title_to_directions.csv')
...
csv_directory = "C:/Users/yewji/FYP_20297501/server/recipe_matching/gpt-3"
...
if choice == 1:
    df = pd.read_csv("C:/Users/yewji/FYP_20297501/server/recipe_matching/gpt-3/recipes.csv")
    create_csv(csv_directory, df)

elif choice == 2:
    df = pd.read_csv("C:/Users/yewji/FYP_20297501/server/recipe_matching/gpt-3/ingredients_to_title.csv")
    recipes_df = pd.read_csv("C:/Users/yewji/FYP_20297501/server/recipe_matching/gpt-3/recipes.csv")
