...
print(df.groupby(['intent', 'label', 'data_type']).count())
...
for epoch in tqdm(range(1, epochs+1)):
    model.train()
    loss_train_total = 0
    progress_bar = tqdm(dataloaders_train, desc='Epoch {:1d}'.format(epoch), leave=False, disable=False)
    ...
    save_path = 'server/chatbot_bert/data_volume'
...
model.load_state_dict(torch.load('server/chatbot_bert/data_volume/finetuned_BERT_epoch_1.model', map_location=torch.device('cpu')))
